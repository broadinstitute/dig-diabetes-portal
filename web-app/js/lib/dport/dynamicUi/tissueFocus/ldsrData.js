...
mpgSoftware.dynamicUi.ldsrTissueTable = (function () {
    ...
    var processLdsrDataForTissueTable = function (data,rawGeneAssociationRecords) {
        ...
        if ( ( typeof data !== 'undefined') &&
            ...
            combinedRecord.header['tissues'] = _.map(_.uniqBy(filteredData,'tissue_name'),function(o){return o.tissue_name.replace('\'','').toLowerCase()});
            _.forEach(filteredData, function (oneRec) {
                combinedRecord.contents.push({
                    ancestry:oneRec.ancestry,
                    tissue:oneRec.tissue_name.replace('\'','').toLowerCase(),
     ...
     */
    var displayLdsrDataForTissueTable = function (idForTheTargetDiv, objectContainingRetrievedRecords, callingParameters) {
