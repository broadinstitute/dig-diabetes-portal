...
mpgSoftware.dynamicUi.abcVariantTable = (function () {
     ...
     * @returns {*}
     */
    var processRecordsFromAbc = function (data, rawGeneAssociationRecords) {
        if ( typeof data !== 'undefined'){
            rawGeneAssociationRecords.empty();
            _.forEach(data, function (oneRec) {
                rawGeneAssociationRecords.push(oneRec);
            });
     ...
     */
    var displayTissueInformationFromAbc = function (idForTheTargetDiv, objectContainingRetrievedRecords) {
