    ...
    mpgSoftware.datasetsPage = (function () {
        ...
        var displaySelectedTechnology = function (filterDatatype,doNotRedraw, aboutTheDataAjaxURL) {
            ...
            $.ajax({
                ...
                var newDatasets = ["GIANT 2018 exome", "WMHV", "COPD", "Accelerometer-derived", "Hong Kong", "Albuminuria", "TOPMed", "Heart failure", "oxyhemoglobin", "apnea", "IVGTT", "COGENT", "GLGC exome", "Inflammation", "Singapore Prospective"];
