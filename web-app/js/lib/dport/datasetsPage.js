    ...
    mpgSoftware.datasetsPage = (function () {
        ...
        var displaySelectedTechnology = function (filterDatatype,doNotRedraw, aboutTheDataAjaxURL) {
            ...
            $.ajax({
                ...
                var newDatasets = ["WMHV", "COPD", "Accelerometer", "Living", "Eye", "Japan GWAS", "Albuminuria", "TOPMed", "Heart failure", "T2D-GENES", "MEDIA", "VATGen", "FinnMetSeq", "Liver", "BioMe", "Osteoporosis", "2019", "oxyhemoglobin", "apnea"];
