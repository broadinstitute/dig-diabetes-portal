...
(function () {
    ...
    baget.varsImpacter = function (options) {
        ...
        instance.render = function (currentSelection) {
            ...
            /// check the data
            if(!data){
                throw new Error('varsImpacter expects data');
            }

            if( !Array.isArray(data) ){
                throw new Error('varsImpacter expects array data, even if length 0');
            }
            ...
            var containerRec = svg.append("rect")
                .attr("class", "overlay")
                .attr("width", width)
                .attr("height", height)
        ...
        instance.tooltipLocation = function (x) {
            if (!arguments.length) return tooltipLocation;
            tooltipLocation = x;
            return instance;
        };
