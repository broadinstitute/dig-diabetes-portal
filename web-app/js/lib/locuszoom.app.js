...
LocusZoom.Data.Source.prototype.parseArraysToObjects = function(x, fields, outnames, trans) {
    ...
    // We need a custom error message for the T2D portal, since the more generalized message below conveys no useful information to our users
    var t2dPortalCustomErrorMessage = "No variants in range for this data set. Expand the range, or try a different data set.";
    ...
    fields.forEach(function(f, i) {
       // if (!(f in x)) {throw "field " + f + " not found in response for " + outnames[i];}
        if (!(f in x)) {throw t2dPortalCustomErrorMessage;}
    });
