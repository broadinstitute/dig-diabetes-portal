...
<style>
    ...
    table.dataTable th.niceHeaders.sorting {
        background-image: url('../../css/lib/datatables/sort_both2.png');
    ...
    table.dataTable th.datatype-header.sorting {
        background-image: url('../../css/lib/datatables/sort_both2.png');
    }
</style>
...
<script>
    ...
    var filtersAsJson, translatedFilters, domSelectors;
...
<div><button onclick="mpgSoftware.variantSearchResults.buildVariantResultsTable(domSelectors);">Call</button> </div>
