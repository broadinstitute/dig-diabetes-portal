        ...
        <div class="variantWF-container">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-3" style="padding-top:15px;">
                    ...
                    <g:elseif test="${g.portalTypeString()?.equals('stroke')}"><div class="dk-t2d-green dk-tutorial-button dk-right-column-buttons"><a href="https://s3.amazonaws.com/broad-portal-resources/stroke/tutorials/Cerebrovascular_VF_Tutorial.pdf" target="_blank">Variant Finder tutorial</a></div></g:elseif>
                    <g:else><div class="dk-t2d-green dk-tutorial-button dk-right-column-buttons"><a href="https://s3.amazonaws.com/broad-portal-resources/stroke/tutorials/VariantFinderTutorial.pdf" target="_blank">Variant Finder tutorial(?)</a></div></g:else>
                </div>
            </div>
