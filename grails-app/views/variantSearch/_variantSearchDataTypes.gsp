...
<g:if test="${show_gwas}">
    ...
    <div class="col-md-6">
        ...
        <g:renderSigmaSection>
            Select SIGMA to see results from all data types generated by the project (including exome sequencing, exome chip, and Omni GWAS). Select DIAGRAM to access results from DIAGRAM-3, the largest current GWAS dataset for type 2 diabetes.
        </g:renderSigmaSection>
