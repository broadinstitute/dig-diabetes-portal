...
<g:if test="${g.portalTypeString()?.equals('bone')}">
 ...
 %{--comment out this section for 52k demo site                   --}%
                <g:else>
                    ...
                    <h1 style="display:block; font-size:65px; letter-spacing:-0.03em; width:550px; margin-top: 0px;"><span style="color:#F58A1F;font-family: 'Oswald'; ">116 datasets,</span> <span style="color:#80C242;font-family: 'Oswald'; ">262 traits</span></h1>
...
 </g:elseif>
                    ...
                    <g:elseif test="${g.portalTypeString()?.equals('sleep')}">
                        ...
                        <g:else>
                            ...
                            <h5 style="font-size: 18px; font-weight: 600; margin-top: 20px; border-bottom: solid 1px #ccc; padding-bottom: 8px;">Scientific Collaborators</h5>
                            ...
                            <h5 style="font-size: 18px; font-weight: 600; margin-top: 20px; border-bottom: solid 1px #ccc; padding-bottom: 8px;">Funders</h5>
