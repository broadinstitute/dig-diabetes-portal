...
<div class="fluid front-top-banner front-top-banner-${g.portalTypeString()}">
 ...
 %{--comment out this section for 52k demo site                   --}%
                <g:else>
                    ...
                    <h1 style="display:block; font-size:65px; letter-spacing:-0.03em; width:550px; margin-top: 0px;"><span style="color:#F58A1F;font-family: 'Oswald'; ">80 datasets,</span> <span style="color:#80C242;font-family: 'Oswald'; ">189 traits</span></h1>
                    ...
                    <g:elseif test="${g.portalTypeString()?.equals('bone')}"> 
                        ...
                        <p><a href="http://www.ifmrs.org" target="_blank" style="float: left; display:block; margin-right: 20px;"><img src="${resource(dir:'images/organizations', file:'IFMRS_logo_large.jpg')}" style="width:200px; margin-top: 10px;"></a>
                            ...
                            <a href="https://medicine.iu.edu/research/centers-institutes/musculoskeletal-health/" target="_blank" style="float: left; display:block; margin-right: 10px;">
                                <img src="${resource(dir:'images/organizations', file:'ICMH_logo.png')}" style="width:200px; margin-top:15px; margin-left:5px;"></a>
                            <a href="http://www.cancerandbone.org/" target="_blank" style="float: left; display:block; margin-right: 10px;">
                                <img src="${resource(dir:'images/organizations', file:'CABS_logo.png')}" style="width:200px; margin-top:15px; margin-left:5px;"></a>
