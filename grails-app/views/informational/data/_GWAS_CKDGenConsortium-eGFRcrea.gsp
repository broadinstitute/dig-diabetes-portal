<script class="panel-body" id="GWAS_CKDGenConsortium-eGFRcrea_script" type="x-tmpl-mustache">
    <h4>Dataset</h4>
...
<div class="citation"><g:message code="informational.shared.publications.Pattaro_2016_NatCommun.citation"></g:message> </div>
</div></p>
