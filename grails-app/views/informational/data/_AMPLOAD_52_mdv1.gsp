<script class="panel-body" id="AMPLOAD_52_mdv1_script" type="x-tmpl-mustache">
    ...
    <tr><td>1,997</td><td>0</td><td><a onclick="showSection(event)">Hoorn Diabetes Care System cohort</a>
    ...
    <p><g:message code="informational.data.project.Hoornstudies"></g:message></p><br /><br /><br /><br />

<h4><g:message code="informational.shared.headers.exptsumm"></g:message></h4>
<p><g:message code="informational.data.exptsumm.Hoornstudies"></g:message></p>
<p><g:message code="informational.data.exptsumm.Hoornstudies2"></g:message></p>

    <h4>Accessing Hoorn DCS 2019 results</h4>
