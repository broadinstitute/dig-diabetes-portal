<script class="panel-body" id="GWAS_DCSP2a610_script" type="x-tmpl-mustache">
   ...
   <h4><g:message code="informational.shared.headers.publications"></g:message></h4>
    ...
    <tr><td>1081</td><td>0</td><td><a onclick="showSection(event)">Diabetic Cohort (DC)</a>
    ...
    <tr><td>0</td><td>1006</td><td><a onclick="showSection(event)">Singapore Prospective Study Program (SP2)</a>
