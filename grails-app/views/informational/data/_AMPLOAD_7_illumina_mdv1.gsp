<script class="panel-body" id="AMPLOAD_7_illumina_mdv1_script" type="x-tmpl-mustache">
...
<p><g:message code="informational.data.exptsumm.GoDARTS_illumina"></g:message></p>

    <h4>Accessing GoDarts data</h4>
