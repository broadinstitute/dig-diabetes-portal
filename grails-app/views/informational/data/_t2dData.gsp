...
<script>
   ...
   // mpgSoftware.datasetsPage.onClickdatatype();
    //mpgSoftware.datasetsPage.onClickPhenotypeGroup(selectedPhenotypegroup);
    //mpgSoftware.datasetsPage.onClickPhenotypelevel2(selectedLevel2Phenotype);
</script>
