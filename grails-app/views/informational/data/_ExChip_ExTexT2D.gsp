<script class="panel-body" id="ExChip_ExTexT2D_script" type="x-tmpl-mustache">
    ...
    <p><div class="paper">
<g:message code="informational.shared.publications.Mahajan_2018_NatGenet"></g:message><br>
...
<h4><g:message code="informational.shared.headers.dataset_subjects"></g:message></h4>
    ...
    <tr><th colspan="4">Subjects in the ExTexT2D exome chip analysis dataset</th></tr>
...
%{--<hr>--}%
%{--<h3><g:message code="informational.ExChip_GoT2D_title"></g:message></h3>--}%
    %{--<h4><g:message code="informational.shared.headers.publications"></g:message></h4>--}%
            ...
            %{--<div style="display: none;" class="cohortDetail">--}%
                %{--<table border="1">--}%
                    ...
                    %{--<tr>--}%
                        %{--<td valign="top">--}%
                            %{--<ul>--}%
                                %{--<li>Cases had T2D diagnosed between the ages of 35-70 years (inclusive). The diagnosis of diabetes was based on either current prescribed treatment with diabetes-specific medication or, in the case of individuals treated with diet alone, laboratory evidence of diabetes as defined by the WHOS8,S38</li>--}%
                                %{--<li>Cases were excluded if they had an established (clinical and/or molecular) diagnosis of monogenic diabetes (e.g. maturity-onset diabetes of the young, mitochondrial diabetes) or if they had been treated with regular insulin therapy within 1 year of diagnosis. No islet autoantibodies were measured</li>--}%
                            %{--</ul>--}%
                        %{--</td>--}%
                        %{--<td valign="top">--}%
                            %{--<li>Controls were defined as having no diagnosis of diabetes at the time of recruitment (or subsequently), fasting glucose &le;7.0 mmol/l, HbA1c &le;6.4% and age < 80 years</li>--}%
                        %{--</td></tr>--}%
                %{--</table>--}%
            %{--</div></td><td>European</td></tr>--}%
            ...
            %{--<div style="display: none;" class="cohortDetail">--}%
                %{--<table border="1">--}%
                    ...
                    %{--<tr>--}%
                        %{--<td valign="top">--}%
                            %{--<ul>--}%
                                %{--<li>Known T2D or fasting whole blood glucose &ge; 6.1mmol/l</li>--}%
                            %{--</ul>--}%
                        %{--</td>--}%
                        %{--<td valign="top">--}%
                            %{--<li>Controls were defined as having no diagnosis of diabetes at the time of recruitment (or subsequently), whole blood glucose &le;6.0 mmol/l</li>--}%
                        %{--</td></tr>--}%
            ...
            %{--<div style="display: none;" class="cohortDetail">--}%
                %{--<table border="1">--}%
                    ...
                    %{--<tr>--}%
                        ...
                        %{--</td>--}%
                        %{--<td valign="top">--}%
                            %{--<li>Controls were defined as having no diagnosis of diabetes at the time of recruitment</li>--}%
                        %{--</td></tr>--}%
                %{--</table></div></td><td>European</td></tr>--}%
...
%{--<h4><g:message code="informational.shared.headers.project"></g:message></h4>--}%
    ...
    %{--<h5>Type 2 Diabetes Genetic Exploration by Next-Generation Sequencing in Ethnic Samples (T2D-GENES) <small><a--}%
            %{--href="http://www.type2diabetesgenetics.org/projects/t2dGenes" target="_blank">Learn more ></a></small></h5>--}%
