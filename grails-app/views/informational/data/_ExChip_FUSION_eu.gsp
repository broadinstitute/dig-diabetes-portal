<script class="panel-body" id="ExChip_FUSION_eu_script" type="x-tmpl-mustache">
...
<p><g:message code="informational.data.overview.ExChipFUSION4"></g:message></p>
<p><g:message code="informational.data.overview.ExChipFUSION5"></g:message></p>
...
<h4>Accessing FUSION exome chip analysis results</h4>
