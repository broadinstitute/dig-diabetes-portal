...
<div class="col-md-12">
    ...
    <g:if test="${g.portalTypeString()?.equals('t2d')}">
        ...
        <h4><g:message code="informational.policies.data_transfer.header"></g:message></p></h4>
                    ...
                    <p><g:message code="informational.policies.data_release.process.section_2a"></g:message></p>
    ...
    <g:elseif test="${g.portalTypeString()?.equals('lung')}">
        <div class="col-md-9">
            ...
            <p> <g:message code="informational.policies.lung.subheader1"></g:message></p>

            <p><g:message code="informational.policies.lung.subheader2"></g:message></p>

            <p><g:message code="informational.policies.lung.subheader3"></g:message></p>
            ...
            <p><g:message code="informational.policies.lung.google"></g:message></p>
            ...
            <p><g:message code="informational.policies.lung.citing"></g:message></p>

            <p><g:message code="portal.stroke.use.citation.request"></g:message></p>

            <p><g:message code="portal.lung.use.citation.itself"></g:message></p>
