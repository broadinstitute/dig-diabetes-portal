...
<div class="col-md-12">
    ...
    <g:elseif test="${g.portalTypeString()?.equals('als')}">
        <div class="col-md-9">
            ...
            <p> <g:message code="informational.policies.als.subheader1"></g:message></p>

            <p><g:message code="informational.policies.als.subheader2"></g:message></p>

            <p><g:message code="informational.policies.als.subheader3"></g:message></p>
            ...
            <p><g:message code="informational.policies.als.google"></g:message></p>
            ...
            <p><g:message code="informational.policies.als.citing"></g:message></p>

            <p><g:message code="portal.stroke.use.citation.request"></g:message></p>

            <p><g:message code="portal.als.use.citation.itself"></g:message></p>
