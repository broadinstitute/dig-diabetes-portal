...
<div class="row">
    <div class="col-xs-12">
		...
		<h4><g:message code="informational.policies.data_agg.title" /></h4>
		...
		<a href='${createLink(controller:"informational", action:"sharingPolicy")}'><g:message code="mainpage.click.here"/></a></p>
