    ...
    <div class="container dk-static-content">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <h1 class="dk-page-title"><g:message code="informational.about_epi.header"/></h1>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <h3 class="dk-blue-bordered"><g:message code="informational.about_EpiData.header"/></h3>
                <p><g:message code="informational.about_epi.section1"/></p>
