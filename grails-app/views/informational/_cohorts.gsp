...
<h4 style="padding-bottom: 20px; line-height: 1.4em;">
    Data from T2D-GENES currently available on this portal include about 10,000 exomes --
...
<div class="cohort">
    ...
    <div class="bullets">
        ...
        <ul>
            ...
            <li>Prevalent T2D  defined as previous physician diagnosis of diabetes on treatment, with onset of diabetes after the age of 18 years and without insulin use in the first year after diagnosis; or fasting plasma glucose ≥7.0 mmol/L</li>
        </ul>
    </div>
