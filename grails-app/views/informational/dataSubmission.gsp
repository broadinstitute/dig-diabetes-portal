...
<div id="main">
    ...
    <h3><g:message code="informational.dataSubmission.section1title"></g:message></h3>
    <g:message code="informational.dataSubmission.section1"></g:message>
    <h3><g:message code="informational.dataSubmission.section2title"></g:message></h3>
    <g:message code="informational.dataSubmission.section2"></g:message>
    <h3><g:message code="informational.dataSubmission.section3title"></g:message></h3>
    <g:message code="informational.dataSubmission.section3"></g:message>
    <h3><g:message code="informational.dataSubmission.section4title"></g:message></h3>
    ...
    <h3 align="center"><g:message code="informational.dataSubmission.section6"></g:message></h3>

    <h2 align="center"><g:message code="informational.dataSubmission.section9"></g:message></h2>
        <div class="separator"></div>
