                    ...
                    dataAnnotationTypes: [
                        {
                            ...
                            displayRefinedContextFunction:mpgSoftware.dynamicUi.variantTableHeaders.displayRefinedVariantsInARange,
                            prepareDataForApiCall:mpgSoftware.dynamicUi.variantTableHeaders.prepareDataForApiCall,
                            urlOfTheApiCall:  '${g.createLink(controller: "RegionInfo", action: "fillCredibleSetTable")}',
                            ...
                            // the fields we will fill indicating the range of this call
                            chromosomeInput:'input#chromosomeInput',
                            startExtentInput:'input#startExtentInput',
                            endExtentInput:'input#endExtentInput',
                            phenotypePicker:'select.phenotypePicker',
                            annotationSelectorChoice:'#annotationSelectorChoice',
                            // this call blocks all the others
                            unblockOnDisplay: true
                        }
                        ,
                            { // a row in the table requested from VHDR
                                code: 'VAR_CODING',
                                category: 'Annotation',
                                displayCategory: 'Annotation',
                        ...
                        ,
                        {
                            ...
                            packagingString:'mpgSoftware.dynamicUi.abcVariantTable',
                            processEachRecord:mpgSoftware.dynamicUi.abcVariantTable.processRecordsFromAbc,
                            displayRefinedContextFunction:mpgSoftware.dynamicUi.abcVariantTable.displayTissueInformationFromAbc,
                            prepareDataForApiCall:mpgSoftware.dynamicUi.abcVariantTable.prepareDataForApiCall,
                            urlOfTheApiCall:  '${g.createLink(controller: "RegionInfo", action: "retrieveAbcData")}',
                        ...
                        ,
                        {
                            ...
                            subcategory: 'TissueDominant',
                            displaySubcategory: 'TissueDominant',
                            headerWriter:'notUsed',
                            cellBodyWriter:'sharedTableBodyTissueSpecific',
                            cellBodyWriterTissueSpecific:'sharedTableBodyTissueSpecific',
                            categoryWriter:'notUsed',
                            drillDownCategoryWriter:'notUsed',
                            subCategoryWriter:'notUsed',
                            drillDownSubCategoryWriter:'notUsed',
                            tissueCategoryWriter:'notUsed',
                            tissueSubCategoryWriter:'notUsed',
                            numberRecordsCellPresentationStringWriter:'notUsed',
                            significanceCellPresentationStringWriter:'notUsed',
                            packagingString:'mpgSoftware.dynamicUi.variantTableHeaders',
                            sortingSubroutine:'TissueDominant',
                            internalIdentifierString:'doesNotHaveAnIndependentFunction',
                            nameOfAccumulatorField:'notUsed',
                            nameOfAccumulatorFieldWithIndex:'notUsed'
                        }
                        ...
                        ,
                        {
                            ...
                            displayRefinedContextFunction:mpgSoftware.dynamicUi.atacSeqVariantTable.displayTissueInformationFromDnase,
                            prepareDataForApiCall:mpgSoftware.dynamicUi.atacSeqVariantTable.prepareDataForApiCall,
                        ...
                        ,
                        {
                            ...
                            displayRefinedContextFunction:mpgSoftware.dynamicUi.dnaseVariantTable.displayTissueInformationFromDnase,
                            prepareDataForApiCall:mpgSoftware.dynamicUi.dnaseVariantTable.prepareDataForApiCall,
                            urlOfTheApiCall:  '${g.createLink(controller: "RegionInfo", action: "retrieveVariantAnnotations")}',
