...
<div class="variantAnnotation variantIsCoding initialLinearIndex_{{indexInOneDimensionalArray}}">
Annotation
</div>
</script>

<script id="variantIsCodingSubcategoryLabel"  type="x-tmpl-mustache">
<div class="variantAnnotation variantIsCoding staticValuesLabelInTissueTable initialLinearIndex_{{indexInOneDimensionalArray}}">
Coding
