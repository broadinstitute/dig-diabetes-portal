...
<script id="magmaPvalueTableNumberRecordsCellPresentationString"  type="x-tmpl-mustache">
records={{numberRecords}}
</script>

<script id="magmaPvalueTableSignificanceCellPresentationString"  type="x-tmpl-mustache">
p={{significanceValueAsString}}
</script>


<script id="magmaTableSubCategory"  type="x-tmpl-mustache">
...
<script id="magmaTableBody"  type="x-tmpl-mustache">
