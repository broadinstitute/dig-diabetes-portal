...
<script id="variantResultsMainStructuralTemplate" type="x-tmpl-mustache" style="display: none;">
    ...
    <div class="container dk-t2d-content" style="padding-top: 40px;">
        <div class="row">
            ...
            <div class="col-md-3" style="padding-top:15px;">
                <div class="dk-t2d-blue dk-copy-button dk-right-column-buttons"><a href="#" id="copyURL" onclick="copyVariantSearchURL();">Copy URL to share the search result</a></div>
    ...
    <div class="dk-t2d-blue dk-edit-button dk-right-column-buttons-compact" style="float: right; margin-right: 20px;"><a href="javascript:;" data-toggle="modal" data-target="#{{dataModal}}">Modify columns shown</a></div>
