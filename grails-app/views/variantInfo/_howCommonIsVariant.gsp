    ...
    <div class="accordion-inner">
        ...
        <g:if test="${show_exseq}">
            ...
            <div id="howCommonIsExists" style="display: block">
                ...
                <p>
            <g:message code="variant.alleleFrequency.subtitleA" default="Minor allele frequencies"/> <g:helpText title="variant.alleleFrequency.help.header" placement="bottom" body="variant.alleleFrequency.help.text"/> <g:message code="variant.alleleFrequency.subtitleB" default="in ancestry-specific data sets"/>
