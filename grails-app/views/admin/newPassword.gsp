    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 login-header">
                <h1><p><g:message code="users.message.password_reset"/></p></h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <g:form action='updatePassword' method='POST' id='passwordResetForm' class='form form-horizontal cssform' autocomplete='off'>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-3" for="oldPassword"><g:message code="users.attributes.current_password"/>:</label>
