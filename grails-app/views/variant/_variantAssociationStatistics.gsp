        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                variantAssociationStatistics({"IN_GWAS":true,
                        ...
                        "ID":"<%=variantToSearch%>",
                        "GWAS_T2D_PVALUE":parseFloat(collector["d0"][0].count[0]),
                        "GWAS_T2D_OR":parseFloat(collector["d0"][1].count[0]),
                        "EXCHP_T2D_P_value":parseFloat(collector["d0"][0].count[0]),
                        "EXCHP_T2D_BETA":parseFloat(collector["d0"][0].count[0]),
                        "_13k_T2D_P_EMMAX_FE_IV":parseFloat(collector["d0"][0].count[0]),
                        "_13k_T2D_OR_WALD_DOS_FE_IV":parseFloat(collector["d0"][0].count[0]),
                        "SIGMA_T2D_P":parseFloat(collector["d0"][0].count[0]),
                        "SIGMA_T2D_OR":parseFloat(collector["d0"][0].count[0])},
                        ${show_sigma},
                        "<%=variantToSearch%>",
