...
%{--<h2><strong>What effect does <%= UTILS.get_variant_title(variant) %> have on the encoded protein?</strong></h2>--}%
...
%{--<div class="radio-inline">--}%
    %{--<label>--}%
        %{--<input class="transcript-radio" type="radio" name="transcript_check" id="transcript-<%= transcript_id %>" value="<%= transcript_id %>" >--}%
        %{--<%= transcript_id %>--}%
    %{--</label>--}%
%{--</div>--}%
%{--<% }); %>--}%
