...
<div class="container-fluid">
    <div class="row dk-sigma-small-nav text-center visible-sm visible-xs">
        <div class="col-sm-4 col-xs-4 sigma-about-gradient">
            <g:if test="${params.section == 'about' || params.section == null}">
                <g:link action='sigma' params="[section: 'about']"><strong><g:message code="sigmasite.home.section.caps.about" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'about']"><g:message code="sigmasite.home.section.caps.about" /></g:link>
            </g:else>
        </div>
        <div class="col-sm-4 col-xs-4 sigma-data-gradient">
            <g:if test="${params.section == 'data'}">
                <g:link action='sigma' params="[section: 'data']"><strong><g:message code="sigmasite.home.section.caps.data" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'data']"><g:message code="sigmasite.home.section.caps.data" /></g:link>
            </g:else>
        </div>
        <div class="col-sm-4 col-xs-4 sigma-papers-gradient">
            <g:if test="${params.section == 'papers'}">
                <g:link action='sigma' params="[section: 'papers']"><strong><g:message code="sigmasite.home.section.caps.papers" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'papers']"><g:message code="sigmasite.home.section.caps.papers" /></g:link>
            </g:else>
        </div>
    </div>
    <div class="row dk-sigma-small-nav text-center visible-sm visible-xs">
        <div class="col-sm-4 col-xs-4 sigma-partners-gradient">
            <g:if test="${params.section == 'partners'}">
                <g:link action='sigma' params="[section: 'partners']"><strong><g:message code="sigmasite.home.section.caps.partners" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'partners']"><g:message code="sigmasite.home.section.caps.partners" /></g:link>
            </g:else>
        </div>
        <div class="col-sm-4 col-xs-4 sigma-learn-gradient">
            <g:if test="${params.section == 'learn'}">
                <g:link action='sigma' params="[section: 'learn']"><strong><g:message code="sigmasite.home.section.caps.learn" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'learn']"><g:message code="sigmasite.home.section.caps.learn" /></g:link>
            </g:else>
        </div>
        <div class="col-sm-4 col-xs-4 sigma-contact-gradient">
            <g:if test="${params.section == 'contact'}">
                <g:link action='sigma' params="[section: 'contact']"><strong><g:message code="sigmasite.home.section.caps.contact" /></strong></g:link>
            </g:if>
            <g:else>
                <g:link action='sigma' params="[section: 'contact']"><g:message code="sigmasite.home.section.caps.contact" /></g:link>
            </g:else>
        </div>
    </div>
    <g:if test="${params.section == 'about' || params.section == null}"> 
        <div class="row sigma-about-gradient dk-sigma-section-header visible-lg visible-md">
            <div class="col-lg-3 col-md-3 text-center dk-sigma-nopadding"><div class="sigma-about-gradient dk-sigma-section-link"><g:link action='sigma' params="[section: 'about']"><g:message code="sigmasite.home.section.caps.about" /></g:link></div></div>
    ...
    <div class="row">
        ...
        <div class="col-lg-offset-0 col-md-offset-0 col-lg-8 col-md-8 col-sm-offset-1 col-xs-offset-1 col-sm-10 col-xs-10">
            <g:if test="${params.section == 'about' || params.section == null}"> 
                <g:render template="sigma/about"/> 
            </g:if> 
            <g:if test="${params.section == 'data'}"> 
                <g:render template="sigma/data"/> 
            </g:if> 
            <g:if test="${params.section == 'papers'}"> 
                <g:render template="sigma/papers"/> 
            </g:if> 
            <g:if test="${params.section == 'partners'}"> 
                <g:render template="sigma/partners"/> 
            </g:if> 
            <g:if test="${params.section == 'learn'}"> 
                <g:render template="sigma/learn"/> 
            </g:if> 
            <g:if test="${params.section == 'contact'}"> 
                <g:render template="sigma/contact"/> 
            </g:if> 
        </div>
    </div>
</div>
