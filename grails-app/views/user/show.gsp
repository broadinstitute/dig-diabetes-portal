    ...
    <div class="container">
        ...
        <div class="dport-template">
            <div class="dport-template-view">
                <a href="#show-user" class="skip" tabindex="-1">Skip to content</a>

                <div class="row">
                    <div class="col-md-4"><h1>Show a user</h1></div>

                    <div class="col-md-4"><g:link class="list" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link></div>
                    <div class="col-md-4"><g:link class="create" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></div>
                </div>
