                        ...
                        dataAnnotationTypes: [
                            {   code: 'FEGT',
                                ...
                                { key: "Gene_name",
                                    display:"Gene name",
                                    pos:1,subPos:0,
                                    helptext: '<g:helpText title="variantTable.columnHeaders.shared.dataSet.help.header" placement="bottom" body="variantTable.columnHeaders.shared.dataSet.help.text"/>'},
                                { key: "Locus_name",
                                    display:"Locus name",
                                    pos:1,subPos:1},
