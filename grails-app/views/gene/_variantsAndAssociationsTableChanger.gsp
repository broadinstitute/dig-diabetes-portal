...
%{--<div class="modal-content">--}%
            ...
            %{--<div class="dk-modal-form-input-group">--}%
                ...
                %{--<div class="dk-modal-form-input-row">--}%
                    ...
                    %{--<div class="dk-variant-search-builder-ui">--}%
                        %{--<div class="checkbox">--}%
                            %{--<label>--}%
                                %{--<input type="checkbox" checked> p-value < 1--}%
                            %{--</label>--}%
                        %{--</div>--}%
                        %{--<div class="checkbox">--}%
                            %{--<label>--}%
                                %{--<input type="checkbox" checked> p-value = 0.5--}%
                            %{--</label>--}%
                        %{--</div>--}%
                    %{--</div>--}%
                %{--</div>--}%
    ...
    %{--<div class="modal-footer dk-modal-footer">--}%
        %{--<button type="button" class="btn btn-primary" data-dismiss="modal">Rebuild table</button>--}%
