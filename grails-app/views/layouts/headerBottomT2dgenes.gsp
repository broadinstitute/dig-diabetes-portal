...
<g:if test="${g.portalTypeString()?.equals('lung')}">
    <div class="container-fluid" id="header-bottom" style="background-color:#7ACCC8;">
        ...
        <div class="menu-wrapper" style="float:right;">
            ...
            <ul class="dk-general-menu" style="list-style: none; float:right; margin:0; padding:10px 0 0 15px; text-align: right;  ">
                ...
                <li class="about-btn" style="display:inline-block;margin-right:15px;padding-bottom: 15px;"><a href="http://3.208.176.209/about/LDKP" target="_blank"><g:message code="portal.header.nav.about"/></a></li>
                <li class="policies-btn" style="display:inline-block;margin-right:15px;padding-bottom: 15px;"><a href="http://3.208.176.209/policies"><g:message code="portal.header.nav.policies"/></a></li>
                <li class="tutorials-btn" style="display:inline-block;margin-right:15px;padding-bottom: 15px;"><a href="${createLink(controller: 'home', action: 'tutorials')}"><g:message code="portal.header.nav.tutorials"/></a><span class="new-dataset-flag" style="position:relative; width: 30px; background-size: 30px; margin-right: -10px;">&nbsp;</span></li>
