...
//         }
    ...
    def retrievePotentialIgvTracks(){
        ...
        JsonSlurper slurper = new JsonSlurper()
        JSONArray allSources = slurper.parseText(t2dDataSourcesJson)
        JSONArray defaultTracks = slurper.parseText(defaultTracksJson)
